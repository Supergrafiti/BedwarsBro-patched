...
public class HintsValidator {
	...
	public static boolean isBedScannerChatMessage() {
		return Main.getConfigBool(CONFIG_MSG.BED_SCANNER_SEND_TEAM) && isPasswordCorrect();
	}
	...
	public static boolean isBlockCounterActive() {
		return Main.getConfigBool(CONFIG_MSG.ITEM_COUNTER_BLOCKS) && isPasswordCorrect();
	}
	...
	public static boolean getNamePlateTeamColor() {
		return Main.getConfigBool(CONFIG_MSG.NAMEPLATE_TEAM_COLOR);
	}
}
